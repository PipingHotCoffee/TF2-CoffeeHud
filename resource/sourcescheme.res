...
Scheme
{
	...
	Colors
	{
		...
		"SelectionBG2"		"100 100 100 255"		// selection background in window w/o focus
		"ListBG"			"100 100 100 255"		// background of server browser, buddy list, etc.
	}
	BaseSettings
	{
		...
		Button.TextColor				"BasWhite"
		Button.BgColor					"43 43 43 255"
		Button.ArmedTextColor			"BasDark"
		Button.ArmedBgColor				"BasBlue"
		Button.DepressedTextColor		"BasDark"
		Button.DepressedBgColor			"BasBlue"
		Button.FocusBorderColor			"0 0 0 0"

		CheckButton.TextColor			"BasWhite"
		CheckButton.SelectedTextColor	"BasWhite"
		CheckButton.BgColor				"43 43 43 255"
		CheckButton.HighlightFgColor	"BasBlue"
		...
		ComboBoxButton.ArrowColor		"BasBlue"
		ComboBoxButton.ArmedArrowColor	"BasBlue"
		...
		Frame.BgColor					"BasDark"
		Frame.OutOfFocusBgColor			"32 32 32 200"
		FrameGrip.Color1				"BasWhite"
		FrameGrip.Color2				"BasDark"
		FrameTitleButton.FgColor		"BasWhite"
		FrameTitleBar.Font				"UIBold"
		FrameTitleBar.TextColor			"BasBlue"
		FrameTitleBar.DisabledTextColor	"10 200 225 200"
		...
		ListPanel.TextColor					"BasWhite"
		ListPanel.BgColor					"BasDark"
		ListPanel.SelectedBgColor			"BasBlue"
		ListPanel.SelectedOutOfFocusBgColor	"100 100 100 128"

		MainMenu.TextColor			"White"
		MainMenu.ArmedTextColor		"BasBlue"
		MainMenu.Inset				"32"

		Menu.TextInset					"6"
		Menu.FgColor			"White"
		Menu.BgColor					"43 43 43 255"
		Menu.ArmedFgColor		"BasBlue"
		Menu.ArmedBgColor				"BasBlue"
		...
		ScrollBarSlider.FgColor				"BasBlue"
		ScrollBarSlider.BgColor				"43 43 43 255"

		Slider.NobColor				"BasWhite"
		Slider.TextColor			"BasWhite"
		...
		TextEntry.SelectedBgColor	"BasBlue"
		...
		GraphPanel.FgColor				"BasWhite"
		GraphPanel.BgColor				"43 43 43 255"
		ListPanel.TextBgColor				"Blank"
		ListPanel.SelectedTextColor			"Black"
		ListPanel.EmptyListInfoTextColor	"OffWhite"
		Menu.TextColor					"BasWhite"
		Menu.ArmedTextColor				"Black"
		Panel.FgColor					"DullWhite"
		Panel.BgColor					"Blank"
		ProgressBar.FgColor				"BasBlue"
		ProgressBar.BgColor				"43 43 43 255"
		PropertySheet.TextColor			"BasWhite"
		PropertySheet.SelectedTextColor	"White"
		PropertySheet.TransitionEffectTime	"0.25"
		RichText.TextColor				"BasWhite"
		RichText.BgColor				"43 43 43 255"
		RichText.SelectedTextColor		"Black"
		RichText.SelectedBgColor		"BasBlue"
		ScrollBar.Wide					17
		SectionedListPanel.HeaderTextColor	"White"
		SectionedListPanel.HeaderBgColor	"Blank"
		SectionedListPanel.DividerColor		"Black"
		SectionedListPanel.TextColor		"DullWhite"
		SectionedListPanel.BrightTextColor	"BasWhite"
		SectionedListPanel.BgColor			"43 43 43 255"
		SectionedListPanel.SelectedTextColor			"Black"
		SectionedListPanel.SelectedBgColor				"BasBlue"
		...
		Console.TextColor			"BasWhite"
		Console.DevTextColor		"BasBlue"
		NewGame.TextColor			"White"
		NewGame.FillColor			"0 0 0 255"
		NewGame.SelectionColor		"BasBlue"
